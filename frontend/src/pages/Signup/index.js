  ...
  return (
    <div className="geral-signup">
      <div className={"container-signup"}>
        <div className={"paper"}>
          <img alt={"Logo"} src={"https://s3.typebot.io/public/workspaces/clua09esq000yu8i4q43s1smg/typebots/clua09n420001njc24p0d7dfn/blocks/g15s2y499p9wqskja5h3jgrs?v=1711989892745"} className="img-logo-signup"></img>
          <h4 className="h4">⚡ Cadastre-se</h4>
          <div>
            <span className="span">
              👋🏻 Comece seu <b>teste GRATUITO</b> de 3 dias do SuperConversa em
              apenas 3 etapas!{" "}
        ...
        <div className="footer">
          <p className="p">
          Copyright ©{" "}
            <a href={"https://artsistemas.cloud"} target={"_blank"}>
              ArtSistemas{""}
            </a>{" "}
            2024{" "}
          </p>
