  ...
  return (
    <div className="geral">
      ...
      <div className={"container-img"}>
        <img alt={"Logo"} src={"https://s3.typebot.io/public/workspaces/clua09esq000yu8i4q43s1smg/typebots/clua09n420001njc24p0d7dfn/blocks/dlypit6zsvy27n5qiw5bfu3h?v=1711990282751"} className="img-login"></img>
      </div>
